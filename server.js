...
dotenv.config("/Users/jakeshimada/Downloads/MyWebsite/.env");
...
//rate limit to prevent dual submission if button is spammed
...
mongoose
    ...
    .then(() => console.log("✅ MongoDB connected & Awaiting"))
    .catch((err) => {
...
app.get("/api/health", (req, res) => {
    return res.json({ ok: true, mongo: mongoose.connection.readyState === 1 });
});

// --- Create ticket ---
app.post("/api/tickets", async (req, res) => {
    try {
        const { firstName, lastName, email, ticketType, quantity, notes } =
            req.body;
